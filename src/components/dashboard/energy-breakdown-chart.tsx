...
const chartConfig: ChartConfig = {
  ...
  'Cold Rooms': { label: 'Cold Rooms', color: 'hsl(var(--chart-1))' },
  'Packing Line': { label: 'Packing Line', color: 'hsl(var(--chart-2))' },
  'Lighting': { label: 'Lighting', color: 'hsl(var(--chart-3))' },
  'Office': { label: 'Office', color: 'hsl(var(--chart-4))' },
};

export function EnergyBreakdownChart({ data }: EnergyBreakdownChartProps) {
  return (
    <Card className="h-full flex flex-col">
      <CardHeader>
        ...
        <CardDescription>
          Breakdown of energy consumption by operational area.
        </CardDescription>
      </CardHeader>
