...
>(({ asChild = false, children, ...props }, ref) => {
  ...
  return (
    <Comp {...props} ref={ref}>
      {children}
      <ChevronDown className="absolute right-2 top-1.5 size-4 transition-transform duration-200 group-data-[state=open]:rotate-180 group-data-[collapsible=icon]:hidden" />
    </Comp>
  )
})
