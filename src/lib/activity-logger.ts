...
export const ActivityTypes = {
  ...
  // Citrus
  CITRUS_CARRY_CREATED: 'CITRUS_CARRY_CREATED',
  CITRUS_CARRY_UPDATED: 'CITRUS_CARRY_UPDATED',
  CITRUS_CARRY_DELETED: 'CITRUS_CARRY_DELETED',
  CITRUS_RETURN_CREATED: 'CITRUS_RETURN_CREATED',
  CITRUS_RETURN_UPDATED: 'CITRUS_RETURN_UPDATED',
  CITRUS_RETURN_DELETED: 'CITRUS_RETURN_DELETED',
  CITRUS_DELIVERY_NOTE_DOWNLOADED: 'CITRUS_DELIVERY_NOTE_DOWNLOADED',
  CITRUS_TRANSACTIONS_EXPORTED: 'CITRUS_TRANSACTIONS_EXPORTED',
};
